    ...
    <footer className="bg-navy-dark px-6 md:px-13 py-13 border-t border-teal/10">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-center">
        ...
        <div className="text-center md:text-left">
          <div className="font-mono text-label text-white/50 tracking-label uppercase mb-1">
            Managed Study Hall · Since 2026
          </div>
          <div className="font-mono text-body font-bold text-white/60 tracking-label">
            STUDYCORE 1.0
          </div>
        </div>
        ...
        <div className="text-center md:text-right">
          ...
          <div className="text-caption text-white/50 font-light leading-relaxed">
