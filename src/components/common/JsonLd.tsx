  ...
  const jsonLd = {
    ...
    mainEntity: [
      ...
      },
      {
        ...
        acceptedAnswer: {
          "@type": "Answer",
          text: "입소 후 별도 안내를 통해 이용할 수 있습니다. 모르는 문제를 사진으로 찍거나 직접 적어 올리면 국희재 수학학원 멘토가 풀이와 개념을 직접 설명해 드립니다.",
        },
      },
      {
        "@type": "Question",
      ...
      {
        "@type": "Question",
        name: "입소 후 적응 기간이 있나요?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "입소 첫날 생활 규정, 교시 시간표, 벌점 제도 전반을 안내드립니다. 규칙이 명확할수록 오히려 편하다는 이야기를 많이 듣습니다. 첫 주 안에 충분히 적응합니다.",
        },
      },
    ],
  };
