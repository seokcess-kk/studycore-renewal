    ...
    <section className="min-h-screen bg-navy-dark relative overflow-hidden flex flex-col">
      ...
      <div className="relative z-[2] flex-1 flex flex-col justify-center p-8 md:p-14">
        ...
        >
          ...
          <motion.p
            variants={fadeUp}
            className="font-serif text-fluid-h3 font-medium text-white/60 tracking-heading leading-ui mb-2 md:mb-3"
          >
            학습관리의 첫 번째 완성형 시스템
          </motion.p>
          ...
          <motion.h1
            variants={fadeUp}
            className="font-serif text-fluid-display font-black leading-heading tracking-heading text-white/90"
          >
        ...
        >
          {[
            ...
            >
              ...
              <span className="text-fluid-h3 text-white/65 font-light tracking-heading leading-ui">
                {text}
              </span>
            </motion.li>
          ))}
        ...
        >
          <p className="text-secondary text-white/60 font-light leading-prose">
            공부는 의지만으로 완성되지 않습니다.
            <br />
            환경과 관리, 그리고 루틴이 함께 설계되어야 합니다.
          </p>
          <p className="text-secondary text-white/60 font-light leading-prose mt-4">
            스터디코어 1.0은{" "}
      ...
      <div className="relative z-[2] border-t border-white/[0.06]">
        ...
        <div className="hidden lg:grid lg:grid-cols-2">
          ...
          >
            <p className="text-reading leading-prose text-white/60 font-light mb-4">
              공부는 의지만으로 완성되지 않습니다.
              <br />
              환경과 관리, 그리고 루틴이 함께 설계되어야 합니다.
            </p>
            <p className="text-reading leading-prose text-white/60 font-light mb-10">
              스터디코어 1.0은{" "}
            ...
            <Link
              href={ROUTES.CONSULT}
              className="cursor-pointer cta-fill cta-fill-teal inline-block px-13 py-4 text-navy-dark text-body font-bold tracking-cta border-[1.5px] border-teal hover:text-teal transition-colors duration-300"
            >
              상담 신청하기
            </Link>
          </motion.div>
        ...
        >
          <Link
            href={ROUTES.CONSULT}
            className="cursor-pointer cta-fill cta-fill-teal block w-full text-center px-6 py-4 text-navy-dark text-body font-bold tracking-cta border-[1.5px] border-teal hover:text-teal transition-colors duration-300"
          >
            상담 신청하기
          </Link>
        </motion.div>
...
function MetaItem({ label, value, href }: { label: string; value: string; href?: string }) {
  return (
    <div className="flex justify-between items-baseline">
      ...
      {href ? (
        <a href={href} target="_blank" rel="noopener noreferrer" className="text-secondary text-white/60 font-light hover:text-teal cursor-pointer transition-colors duration-200">
          {value}
        </a>
      ) : (
        <span className="text-secondary text-white/60 font-light">{value}</span>
      )}
    </div>
  );
}
