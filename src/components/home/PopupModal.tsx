          ...
          >
            ...
            <div className="p-6">
              ...
              {linkUrl && (
                <a
                  href={linkUrl}
                  className="inline-flex items-center border-[1.5px] border-teal bg-teal px-5 py-2.5 text-[13px] font-bold tracking-[0.04em] text-navy-dark hover:bg-transparent hover:text-teal transition-all"
                >
