    ...
    <main className="min-h-screen flex items-center justify-center bg-stone px-6">
      <div className="text-center max-w-md">
        ...
        {process.env.NODE_ENV === "development" && error.digest && (
          <p className="font-mono text-[12px] text-muted/60 mb-6">
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center">
          <button
            onClick={reset}
            className="inline-flex items-center justify-center bg-navy text-white text-[14px] font-bold px-6 py-3 hover:bg-navy-dark transition-colors"
          >
            다시 시도
          </button>
          <Link
